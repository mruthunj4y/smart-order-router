...
interface RouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "looksRareRewardsDistributor()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "looksRareRewardsDistributor",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Router extends Contract {
  ...
  functions: {
    ...
    looksRareRewardsDistributor(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    looksRareToken(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  looksRareRewardsDistributor(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    looksRareRewardsDistributor(overrides?: CallOverrides): Promise<BigNumber>;
