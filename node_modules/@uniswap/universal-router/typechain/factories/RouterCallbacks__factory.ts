...
import type { RouterCallbacks } from "../RouterCallbacks";

export class RouterCallbacks__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<RouterCallbacks> {
    return super.deploy(overrides || {}) as Promise<RouterCallbacks>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): RouterCallbacks {
    return super.attach(address) as RouterCallbacks;
  }
  connect(signer: Signer): RouterCallbacks__factory {
    return super.connect(signer) as RouterCallbacks__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RouterCallbacks {
    return new Contract(address, _abi, signerOrProvider) as RouterCallbacks;
  }
}
