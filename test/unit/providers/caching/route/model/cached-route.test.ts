  ...
  describe('#routePath', () => {
    it('is correctly returned when using V3Route', () => {
      ...
      expect(cachedRoute.routePath).toEqual(
        '[V3]0x6B175474E89094C44Da98b954EedeAC495271d0F/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48/3000'
      );
    });
    ...
    it('is correctly returned when using V2Route', () => {
      ...
      expect(cachedRoute.routePath).toEqual(
        '[V2]0x6B175474E89094C44Da98b954EedeAC495271d0F/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'
      );
    });
