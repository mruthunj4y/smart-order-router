...
import { SupportedRoutes, V3Route } from '../routers/router';
...
export declare class OnChainQuoteProvider implements IOnChainQuoteProvider {
    ...
    protected quoterAddressOverride?: ((useMixedRouteQuoter: boolean, protocol: Protocol) => string | undefined) | undefined;
