...
import { CandidatePoolsBySelectionCriteria, CrossLiquidityCandidatePools, V2CandidatePools, V3CandidatePools } from '../functions/get-candidate-pools';
...
export declare class MixedQuoter extends BaseQuoter<[
    ...
    protected getRoutes(currencyIn: Currency, currencyOut: Currency, v3v2candidatePools: [
        V3CandidatePools,
        V2CandidatePools,
        CrossLiquidityCandidatePools
