...
export declare function getGasCostInNativeCurrency(nativeCurrency: Token, gasCostInWei: BigNumber): import("@surge/sdk-core").CurrencyAmount<Token>;
...
export declare function calculateOptimismToL1FeeFromCalldata(): Promise<[BigNumber, BigNumber]>;
export declare function getL2ToL1GasUsed(data: string, chainId: ChainId): BigNumber;
export declare function calculateGasUsed(chainId: ChainId, route: SwapRoute, simulatedGasUsed: BigNumber, v2PoolProvider: IV2PoolProvider, v3PoolProvider: IV3PoolProvider, providerConfig?: GasModelProviderConfig): Promise<{
...
export declare const calculateL1GasFeesHelper: (route: RouteWithValidQuote[], chainId: ChainId, usdPool: Pair | Pool, quoteToken: Token, nativePool: Pair | Pool | null, providerConfig?: GasModelProviderConfig) => Promise<{
    gasUsedL1: BigNumber;
